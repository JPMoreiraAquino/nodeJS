...
const getEndPoint = async () => {
    ...
    const {data: result} = await axios.get('https://api.sportradar.com/basketball/trial/v2/br/schedules/live/timelines_delta.json?api_key=px897ze33tma4a4kfy3d26r4')
